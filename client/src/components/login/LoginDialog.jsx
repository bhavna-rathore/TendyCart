...
const LoginDialog = ({ open, setOpen, setAccount }) => {
  ...
  switch (name) {
    ...
    case "password":
      ...
      break;
    case "phone":
      errors.phone = /^[0-9]{10}$/.test(value) ? "" : "Invalid phone number";
      break;
    default:
      errors[name] = "";
  }
  ...
  const loginUser = async () => {
    debugger
      if (Object.values(errorFields).some((msg) => msg)) return;
          ...
          {account.view === "login" ? (
            ...
            <Wrapper>
              ...
              <TextField
                ...
                label="Enter Email"
              />
              {errorFields.email && <Error>{errorFields.email}</Error>}
              <TextField
                variant="standard"
                onChange={(e) => onInputChange(e)}
                name="password"
              ...
              <TextField
                ...
                label="Enter Phone"
              />
              {errorFields.phone && <Error>{errorFields.phone}</Error>}
...
// for demo login:email: 12345@gmail.com
//password:1234512345